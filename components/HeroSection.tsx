...
export const HeroSection = (props: ProductTeaserCardProps) => {
  const {
    ...
    headline = "St. George's Most Scenic RV & Tiny Home Park",
    subheadline = "Experience Southern Utah's premier RV destination, nestled just below the legendary Dixie Rock and perched beneath the majestic Red Cliffs. Prime location, panoramic city views, quiet & clean, full hookups.",
    description = "Trusted by snowbirds and travelers alike, Hillside Palms offers unmatched hospitality with spectacular views of downtown St. George and the surrounding red rock formations.",
    ...
    primaryButtonText = "Reserve Your Space",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-12 gap-2">
          ...
          <motion.div
            ...
            style={{
              backgroundImage: "url(/images/hillside-palms-hero.jpg)",
              backgroundSize: "cover",
              backgroundPosition: "center",
              backgroundRepeat: "no-repeat",
            }}
          >
            {/* Video hidden, using static hero image instead */}
          </motion.div>
        </div>
      </div>
    </section>
