...
const stats: StatItem[] = [
  ...
  {
    value: "85%",
    description: "Return guest\nrate",
    delay: 0.4,
  },
  {
    value: "45min",
    description: "Drive to Zion\nNational Park",
    delay: 0.6,
  },
]
...
export const BankingScaleHero = () => {
  ...
  // @return
  return (
    <div className="w-full overflow-hidden bg-white" id="amenities">
      <div className="mx-auto max-w-7xl px-8 py-24 pt-16">
        <div className="grid grid-cols-12 gap-5 gap-y-16">
          <div className="col-span-12 md:col-span-6 relative z-10">
            ...
            >
              Welcome to St. George's Most Beloved RV Park{" "}
              <span
              ...
              >
                featuring full hookups, panoramic city views, and legendary hospitality.
              </span>
            </h2>
            ...
            >
              Experience unmatched views, premium amenities, and a safe, secure environment. Both 50A & 30A service
              available. RVs and tiny homes welcome. Pet-friendly for dogs under 20 lbs.
            </p>
